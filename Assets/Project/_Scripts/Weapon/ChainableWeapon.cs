...
{
    public class ChainableWeapon : WeaponBase
    {
        #region -- Methods --
        ...
        protected override void Awake()
        {
            ...
            {
                AttackStrategy = new ChainableAttackStrategy(this);
            }
        }
        ...
        public ProjectileBase SpawnChainableProjectile(Vector3 targetPosition)
        {
