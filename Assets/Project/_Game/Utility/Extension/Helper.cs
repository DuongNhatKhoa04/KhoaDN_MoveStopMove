...
namespace MoveStopMove.Utility.Extension
{
    ...
    public static class PlayerSaveLoader
    {
        ...
        /// <summary>
        /// Set texture for material in SkinnedMeshRenderer
        /// </summary>
        /// <param name="skinMesh">Target SkinnedMeshRenderer</param>
        /// <param name="texture">Texture want to apply</param>
    ...
    {
        /// <summary>
        /// Build Appearance of character
        /// </summary>
        /// <param name="mainCore">Core</param>
        /// <param name="gameData">Data</param>
        /// <param name="customContext">Custom information</param>
        /// <param name="references">Renderer</param>
        /// <param name="attachment">GameObject used to attach</param>
        /// <param name="provider">DI of decorator</param>
        /// <returns></returns>
