...
namespace MoveStopMove.Core.StateMachine.EnemyState
{
    public class EnemyGroundedState : State
    {
        ...
        public EnemyGroundedState(Character character, FiniteStateMachine stateMachine, CharacterData enemyData, EAnim animation)
        ...
        protected Vector3 GetRandomPointAroundSelf(float radius)
        {
            ...
            // lấy 1 điểm trong hình tròn bán kính radius
